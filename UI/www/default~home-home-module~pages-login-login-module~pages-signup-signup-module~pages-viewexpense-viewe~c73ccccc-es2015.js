...
let HttpService = class HttpService {
    ...
    get(serviceName, queryParam) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Access-Control-Allow-Origin', 'http://localhost:8100');
        headers.append('Access-Control-Request-Method', 'GET');
        const options = { headers, withCredentials: false };
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + queryParam;
        return this.http.get(url, options);
    }
    getExpenseList(serviceName, queryParam) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Access-Control-Allow-Origin', 'http://localhost:8100');
        headers.append('Access-Control-Request-Method', 'GET');
        const options = { headers, withCredentials: false };
...
//# sourceMappingURL=default~home-home-module~pages-login-login-module~pages-signup-signup-module~pages-viewexpense-viewe~c73ccccc-es2015.js.map