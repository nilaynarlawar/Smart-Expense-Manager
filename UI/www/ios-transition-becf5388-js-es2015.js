...
/* harmony import */ var _helpers_e0fdb9d0_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers-e0fdb9d0.js */ "./node_modules/@ionic/core/dist/esm/helpers-e0fdb9d0.js");
/* harmony import */ var _animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animation-86ecfd53.js */ "./node_modules/@ionic/core/dist/esm/animation-86ecfd53.js");
...
const animateBackButton = (rootAnimation, rtl, backDirection, backButtonEl) => {
    ...
    const enteringBackButtonTextAnimation = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
    const enteringBackButtonIconAnimation = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
...
const animateLargeTitle = (rootAnimation, rtl, backDirection, largeTitleEl) => {
    ...
    const clonedLargeTitleAnimation = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
...
const iosTransitionAnimation = (navEl, opts) => {
    try {
        ...
        const rootAnimation = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
        const enteringContentAnimation = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
        rootAnimation
        ...
        if (leavingEl && navEl) {
            const navDecorAnimation = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
        ...
        if (contentEl) {
            ...
            if (enteringTransitionEffectEl) {
                ...
                const enteringTransitionEffect = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                const enteringTransitionCover = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                const enteringTransitionShadow = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
        ...
        enteringToolBarEls.forEach(enteringToolBarEl => {
            const enteringToolBar = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
            enteringToolBar.addElement(enteringToolBarEl);
            rootAnimation.addAnimation(enteringToolBar);
            const enteringTitle = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
            enteringTitle.addElement(enteringToolBarEl.querySelector('ion-title'));
            const enteringToolBarButtons = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
            ...
            const enteringToolBarItems = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
            enteringToolBarItems.addElement(enteringToolBarEl.querySelectorAll(':scope > *:not(ion-title):not(ion-buttons):not([menuToggle])'));
            const enteringToolBarBg = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
            enteringToolBarBg.addElement(shadow(enteringToolBarEl).querySelector('.toolbar-background'));
            const enteringBackButton = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
            ...
            if (backDirection) {
                ...
                if (backButtonEl && !forward) {
                    const enteringBackBtnText = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                    enteringBackBtnText
        ...
        // setup leaving view
        if (leavingEl) {
            const leavingContent = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
            ...
            if (leavingContentEl) {
                ...
                if (leavingTransitionEffectEl) {
                    ...
                    const leavingTransitionEffect = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                    const leavingTransitionCover = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                    const leavingTransitionShadow = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
            ...
            leavingToolBarEls.forEach(leavingToolBarEl => {
                const leavingToolBar = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                leavingToolBar.addElement(leavingToolBarEl);
                const leavingTitle = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                leavingTitle.addElement(leavingToolBarEl.querySelector('ion-title'));
                const leavingToolBarButtons = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                ...
                const leavingToolBarItems = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                const leavingToolBarItemEls = leavingToolBarEl.querySelectorAll(':scope > *:not(ion-title):not(ion-buttons):not([menuToggle])');
                if (leavingToolBarItemEls.length > 0) {
                    leavingToolBarItems.addElement(leavingToolBarItemEls);
                }
                const leavingToolBarBg = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                leavingToolBarBg.addElement(shadow(leavingToolBarEl).querySelector('.toolbar-background'));
                const leavingBackButton = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                ...
                if (backDirection) {
                    ...
                    if (backButtonEl && !backward) {
                        const leavingBackBtnText = Object(_animation_86ecfd53_js__WEBPACK_IMPORTED_MODULE_1__["c"])();
                        leavingBackBtnText
                            .addElement(shadow(backButtonEl).querySelector('.button-text'))
