(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~home-home-module~pages-login-login-module~pages-signup-signup-module~pages-viewexpense-viewe~c73ccccc"],{
...
/* harmony import */ var _config_auth_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../config/auth-constants */ "./src/app/config/auth-constants.ts");
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (postData) {
        // TODO login is the name of you API in spring.
        var queryParam = 'username=' + postData.username + '&password=' + postData.password;
        return this.httpService.get('login/isValidUser?', queryParam);
    };
    AuthService.prototype.addExpense = function (postData) {
        return this.httpService.post('expense/createExpense', postData);
    };
    AuthService.prototype.editExpense = function (postData) {
        return this.httpService.post('expense/editExpense', postData);
    };
    AuthService.prototype.getExpenses = function (userid) {
        var queryParam = 'userId=' + userid;
        return this.httpService.getExpenseList('expense/getExpenseList?', queryParam);
    };
    AuthService.prototype.getExpense = function (expenseId) {
        var queryParam = 'expenseId=' + expenseId;
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.get = function (serviceName, queryParam) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Access-Control-Allow-Origin', 'http://localhost:8100');
        headers.append('Access-Control-Request-Method', 'GET');
        var options = { headers: headers, withCredentials: false };
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + queryParam;
        return this.http.get(url, options);
    };
    HttpService.prototype.getExpenseList = function (serviceName, queryParam) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Access-Control-Allow-Origin', 'http://localhost:8100');
        headers.append('Access-Control-Request-Method', 'GET');
        var options = { headers: headers, withCredentials: false };
...
//# sourceMappingURL=default~home-home-module~pages-login-login-module~pages-signup-signup-module~pages-viewexpense-viewe~c73ccccc-es5.js.map