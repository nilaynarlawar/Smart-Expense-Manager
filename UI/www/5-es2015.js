...
const App = class {
    ...
    componentDidLoad() {
        {
            Object(_helpers_e0fdb9d0_js__WEBPACK_IMPORTED_MODULE_2__["b"])(() => {
                ...
                if (!_config_3c7f3790_js__WEBPACK_IMPORTED_MODULE_1__["b"].getBoolean('_testing')) {
                    __webpack_require__.e(/*! import() | tap-click-1f9d539e-js */ "tap-click-1f9d539e-js").then(__webpack_require__.bind(null, /*! ./tap-click-1f9d539e.js */ "./node_modules/@ionic/core/dist/esm/tap-click-1f9d539e.js")).then(module => module.startTapClick(_config_3c7f3790_js__WEBPACK_IMPORTED_MODULE_1__["b"]));
                }
                if (_config_3c7f3790_js__WEBPACK_IMPORTED_MODULE_1__["b"].getBoolean('statusTap', isHybrid)) {
                    __webpack_require__.e(/*! import() | status-tap-7ab22cb8-js */ "status-tap-7ab22cb8-js").then(__webpack_require__.bind(null, /*! ./status-tap-7ab22cb8.js */ "./node_modules/@ionic/core/dist/esm/status-tap-7ab22cb8.js")).then(module => module.startStatusTap());
                }
                if (_config_3c7f3790_js__WEBPACK_IMPORTED_MODULE_1__["b"].getBoolean('inputShims', needInputShims())) {
                    __webpack_require__.e(/*! import() | input-shims-7a8a317c-js */ "input-shims-7a8a317c-js").then(__webpack_require__.bind(null, /*! ./input-shims-7a8a317c.js */ "./node_modules/@ionic/core/dist/esm/input-shims-7a8a317c.js")).then(module => module.startInputShims(_config_3c7f3790_js__WEBPACK_IMPORTED_MODULE_1__["b"]));
                }
...
const Content = class {
    constructor(hostRef) {
        ...
        this.ionScrollStart = Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionScrollStart", 7);
        this.ionScroll = Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionScroll", 7);
        this.ionScrollEnd = Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionScrollEnd", 7);
    }
    ...
    shouldForceOverscroll() {
        ...
        return forceOverscroll === undefined
            ? mode === 'ios' && Object(_config_3c7f3790_js__WEBPACK_IMPORTED_MODULE_1__["i"])(window, 'mobile')
            : forceOverscroll;
    }
    resize() {
        if (this.fullscreen) {
            Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["f"])(this.readDimensions.bind(this));
        }
    ...
    onScroll(ev) {
        ...
        if (!this.queued && this.scrollEvents) {
            this.queued = true;
            Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["f"])(ts => {
                this.queued = false;
    ...
    render() {
        ...
        this.resize();
        return (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: Object.assign(Object.assign({}, Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_4__["c"])(this.color)), { [mode]: true, 'content-sizing': Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_4__["h"])('ion-popover', this.el), 'overscroll': forceOverscroll }), style: {
                '--offset-top': `${this.cTop}px`,
                '--offset-bottom': `${this.cBottom}px`,
            } }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("main", { class: {
                'inner-scroll': true,
                'scroll-x': scrollX,
                'scroll-y': scrollY,
                'overscroll': (scrollX || scrollY) && forceOverscroll
            }, ref: el => this.scrollEl = el, onScroll: ev => this.onScroll(ev) }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)), transitionShadow ? (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "transition-effect" }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "transition-cover" }), Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "transition-shadow" }))) : null, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "fixed" })));
    }
    get el() { return Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["e"])(this); }
...
const Footer = class {
    ...
    render() {
        ...
        return (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "contentinfo", class: {
                [mode]: true,
...
const handleContentScroll = (scrollEl, mainHeaderIndex, scrollHeaderIndex, remainingHeight = 0) => {
    Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["f"])(() => {
        const scrollTop = scrollEl.scrollTop;
        const lastMainToolbar = mainHeaderIndex.toolbars[mainHeaderIndex.toolbars.length - 1];
        const scale = Object(_helpers_e0fdb9d0_js__WEBPACK_IMPORTED_MODULE_2__["c"])(1, 1 + (-scrollTop / 500), 1.1);
        const borderOpacity = Object(_helpers_e0fdb9d0_js__WEBPACK_IMPORTED_MODULE_2__["c"])(0, (scrollTop - remainingHeight) / lastMainToolbar.el.clientHeight, 1);
        const maxOpacity = 1;
...
const Header = class {
    ...
    async checkCollapsibleHeader() {
        ...
        const canCollapse = (hasCollapse && Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this) === 'ios') ? hasCollapse : false;
    ...
    render() {
        ...
        return (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "banner", class: {
                [mode]: true,
                // Used internally for styling
                [`header-${mode}`]: true,
...
const RouterOutlet = class {
    constructor(hostRef) {
         ...
         */
        this.animated = true;
        this.ionNavWillLoad = Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionNavWillLoad", 7);
        this.ionNavWillChange = Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionNavWillChange", 3);
        this.ionNavDidChange = Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionNavDidChange", 3);
    }
    swipeHandlerChanged() {
        if (this.gesture) {
    ...
    render() {
        return (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null));
    }
    get el() { return Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["e"])(this); }
...
const ToolbarTitle = class {
    ...
    render() {
        ...
        const size = this.getSize();
        return (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: Object.assign({ [mode]: true, [`title-${mode}`]: true, [`title-${size}`]: true }, Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_4__["c"])(this.color)) }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "toolbar-title" }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null))));
    }
    get el() { return Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["e"])(this); }
    static get watchers() { return {
        "size": ["sizeChanged"]
...
const Toolbar = class {
    ...
    render() {
        ...
        return (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: Object.assign(Object.assign({ 'in-toolbar': Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_4__["h"])('ion-toolbar', this.el), [mode]: true }, childStyles), Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_4__["c"])(this.color)) }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "toolbar-background" }), Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "toolbar-container" }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "start" }), Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "secondary" }), Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "toolbar-content" }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)), Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "primary" }), Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "end" }))));
    }
    get el() { return Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["e"])(this); }
